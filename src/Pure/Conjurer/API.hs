...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (CreateResource resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (ReadResource resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (UpdateResource resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (DeleteResource resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (ReadProduct resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (ReadPreview resource) where
...
instance (Typeable resource, ToJSON (Context resource), FromJSON (Context resource)) => Request (ReadListing resource) where
...
publishingAPI 
  :: forall resource. 
    ...
    ) => API '[] (ResourcePublishingAPI resource)
...
readingAPI 
  :: forall resource. 
    ( Typeable resource
    , ToJSON (Context resource), FromJSON (Context resource)
    ) => API '[] (ResourceReadingAPI resource)
